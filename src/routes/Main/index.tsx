...
import { createStackNavigator, StackCardInterpolationProps } from
'@react-navigation/stack';
import { createBottomTabNavigator } from '@react-navigation/bottom-tabs';
import { createDrawerNavigator } from '@react-navigation/drawer';
import { INITIAL, LOADING, HOME, CHOOSE_LOGIN, STATISTICS, USER_INFO, INPUT, SIGN_IN, SIGN_UP }
from '../../constants/path';
import { Initial, Loading, ChooseLogin, Input, SignIn ,SignUp } from 
'../../components/pages';
...
const StaticsDrawer = createDrawerNavigator();
...
function StatisticsWithDrawer() {
    return (
        <StaticsDrawer.Navigator>
            <StaticsDrawer.Screen name={STATISTICS} component={Statistics} />
            <StaticsDrawer.Screen name={USER_INFO} component={UserInfo} />
        </StaticsDrawer.Navigator>
    );
}
